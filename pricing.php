...
<html lang="en">
  ...
  <body class="pricing-body">
    ...
    <main class="pricing-main">
      <div class="container">
        <h1 class="pricing__heading">Plano</h1>
      </div>
      <section id="pricing" class="pricing">
        <div class="container pricing__wrapper">
          <!-- Card 1 -->
          <div class="pricing-card">
            <h4 class="pricing-card__heading">Plano Grátis</h4>
            <p class="pricing-card__description">
              Inscreva-se e experimente as vantagens de ter o nosso produto
            </p>
            ...
            <div class="pricing-card__body">
              <ul class="pricing-card__list">
                ...
                <li class="pricing-card__item pricing-card__item--disabled">
                  <span></span>Assistência de IA
                </li>
                <li class="pricing-card__item pricing-card__item--disabled">
                  <span></span> Comandos personalizados
                </li>
                <li class="pricing-card__item pricing-card__item--disabled">
                  <span></span>Automatização dos dispositivos
                </li>
              </ul>
            </div>
          </div>
          <!-- Card 2 -->
          <div class="pricing-card">
            <h4 class="pricing-card__heading">Plano Básico</h4>
            <p class="pricing-card__description">
              Tenha uma IA que gerencia e protege os seus dispositivos
            </p>
          ...
          <!-- Card 3 -->
          <div class="pricing-card">
            <h4 class="pricing-card__heading">Plano Pro</h4>
            <p class="pricing-card__description">
              Molde o nosso produto de acordo com a sua rotina e necessidades
            </p>
              ...
              <ul class="pricing-card__list">
                ...
                <li class="pricing-card__item">
                  <img
                    ...
                    alt="check icon"
                  />
                  Automatização dos dispositivos
                </li>
              </ul>
            </div>
          </div>
      ...
      <section id="ready" class="ready">
        <div class="container ready__wrapper">
          <h1 class="ready__heading">Já possui uma conta?</h1>
        ...
        <nav class="footer__navigation">
          <ul class="footer-navigation__list">
            <li class="footer-navigation__item">
              <a class="footer-navigation__link" href="pricing.php">Sobre</a>
            </li>
            <li class="footer-navigation__item">
              <a class="footer-navigation__link" href="about.php">Planos</a>
            </li>
            <li class="footer-navigation__item">
