    ...
    <main class="contact-main">
      <div class="container">
        <h1 class="contact__heading">
          Nos envie uma mensagem e nós entraremos em contato com você o mais
          rápido possível.
        </h1>
      </div>
      <div class="container contact__wrapper">
        <section id="contact" class="contact">
          <div class="ct">
            <div class="contact-links">
              <img src="./assets/shared/desktop/face.svg" alt="" srcset="" />
              <a href="">Home Ia</a>
            </div>

            <div class="contact-links">
              <img
                src="./assets/shared/desktop/linkedin-blue.svg"
                alt=""
                srcset=""
              />
              <a href="">linkedin.com/in/homeia</a>
            </div>

            <div class="contact-links">
              <img src="./assets/shared/desktop/x.svg" alt="" srcset="" />
              <a href="">@homeia</a>
            </div>
          </div>
        </section>
        <section class="contact-references">
          <h3 class="contact-references__heading">
            Junte-se a nossa base rica de clientes
          </h3>
